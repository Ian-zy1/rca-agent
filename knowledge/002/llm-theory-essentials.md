...
- **DeepSeek-V3(2024)**: 671B 参数(MoE 架构,每次激活 37B), 上下文 128K
...
|---|---|---|
| GPT-4o(2024) | $5 / 1M token | $15 / 1M |
| GPT-4(2023) | $30 / 1M | $60 / 1M |
| Claude 3.5 Sonnet | $3 / 1M | $15 / 1M |
| **DeepSeek-V3(硅基流动)** | **¥1 / 1M** | **¥2 / 1M** |
| DeepSeek 官方 | ¥0.5 / 1M | ¥1.5 / 1M |

**对比**: DeepSeek-V3 比 GPT-4 便宜 **50-100 倍**,但中文能力强。学习/Demo 选它最划算。
...
| 7B FP16 = **14 GB** | 显存基线 |
| 7B INT4 = **4 GB** | 笔记本能跑 |
| DeepSeek-V3 比 GPT-4 便宜 **50-100 倍** | 学习选它 |
